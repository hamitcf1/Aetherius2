...
export const PERK_DEFINITIONS: PerkDef[] = [
  ...
  { id: 'bladesman', name: 'Bladesman', skill: 'One-Handed', description: 'Critical hits with swords deal 15% more damage per rank.', requires: ['armsman:3'], maxRank: 3, masteryCost: 2, effect: { type: 'combat', key: 'swordCritDamage', amount: 15 } },  // Explicit unlocks for one-handed abilities
  { id: 'riposte_mastery', name: 'Riposte Mastery', skill: 'One-Handed', description: 'Unlocks the Riposte ability (quick counter attack). Requires One-Handed skill 25+.', maxRank: 1, masteryCost: 2 },
  { id: 'slash_mastery', name: 'Slash Mastery', skill: 'One-Handed', description: 'Unlocks the Slash ability (wide AoE slash). Requires One-Handed skill 40+.', maxRank: 1, masteryCost: 2 },
  { id: 'mortal_strike_mastery', name: 'Mortal Strike Mastery', skill: 'One-Handed', description: 'Unlocks Mortal Strike (high damage, damage-reducing debuff). Requires One-Handed skill 60+.', maxRank: 1, masteryCost: 3 },  { id: 'bone_breaker', name: 'Bone Breaker', skill: 'One-Handed', description: 'Maces ignore 15% of armor per rank.', requires: ['armsman:3'], maxRank: 3, masteryCost: 2, effect: { type: 'combat', key: 'maceArmorPen', amount: 15 } },
