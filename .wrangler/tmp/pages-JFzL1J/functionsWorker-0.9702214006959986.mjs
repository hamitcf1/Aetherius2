...
// ../.wrangler/tmp/bundle-k3vRFP/checked-fetch.js
...
function buildSSMLWithCustom(text, settings) {
  ...
  const rate = settings.speakingRate || 1;
  if (pitch !== 0) {
...
// ../.wrangler/tmp/pages-JFzL1J/functionsRoutes-0.5692349389388598.mjs
var routes = [
  {
    routePath: "/api/voice",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-k3vRFP/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-k3vRFP/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9702214006959986.mjs.map
