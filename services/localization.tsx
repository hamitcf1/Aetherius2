  ...
  rest: {
    ...
    perks: {
      ...
      data: {
        ...
        cleaving_mastery: { name: 'Yarma Ustalığı', description: 'Yüksek Çift Elli silah yeteneği gereksinimi olmadan Yarma Saldırısı\'nı (Alan etkili çift elli yarma) açar.' },
    ...
    items: {
      ...
      data: {
        ...
        magicka_potion: 'Maji İksiri',
        plentiful_magicka: 'Bol Maji İksiri',
        healing_potion: 'İyileştirme İksiri',
        plentiful_health: 'Bol Sağlık İksiri',
        plentiful_stamina: 'Bol Dayanıklılık İksiri',
        fortify_smithing: 'Demircilik Takviye İksiri',
        ultimate_health: 'Nihai Sağlık İksiri',
        ...
        tome_chain_lightning: 'Büyü Kitabı: Zincir Şimşek',
        tome_incinerate: 'Büyü Kitabı: Yakıp Kül Etme',
        tome_blizzard: 'Büyü Kitabı: Tip',
