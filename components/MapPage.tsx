...
export const SKYRIM_LOCATIONS: MapLocation[] = [
  ...
  { id: 'dustmans_cairn', name: "Dustman's Cairn", type: 'dungeon', x: 36, y: 50, hold: 'Whiterun Hold', description: 'An ancient Nordic barrow with Silver Hand werewolf hunters.', dangerLevel: 'dangerous', levelRequirement: 10, rumors: ['The Companions have business here', 'Silver Hand fanatics lurk within'], rewards: { gold: { min: 400, max: 800 }, xp: { min: 300, max: 500 }, items: ['Silver Weapons', 'Fragment of Wuuthrad'] } },
  { id: 'silent_moons_camp', name: 'Silent Moons Camp', type: 'dungeon', x: 40, y: 44, hold: 'Whiterun Hold', description: 'Nordic ruins with a lunar forge that enchants weapons at night.', dangerLevel: 'dangerous', levelRequirement: 12, rumors: ['The Lunar Forge creates unique weapons', 'Bandits guard an ancient secret'], rewards: { gold: { min: 350, max: 700 }, xp: { min: 280, max: 450 }, items: ['Lunar Weapon'] } },
  { id: 'shroud_hearth_barrow', name: 'Shroud Hearth Barrow', type: 'dungeon', x: 60, y: 64, hold: 'The Rift', description: 'A haunted Nordic tomb near Ivarstead.', dangerLevel: 'dangerous', levelRequirement: 14, rumors: ['A ghost protects ancient treasure', 'The Sapphire Dragon Claw opens the way'], rewards: { gold: { min: 450, max: 900 }, xp: { min: 350, max: 550 }, items: ['Sapphire Dragon Claw'] } },
  { id: 'vampire_lair', name: 'Movarth\'s Lair', type: 'dungeon', x: 26, y: 28, hold: 'Hjaalmarch', description: 'A dark lair saturated with blood magics near Morthal.', dangerLevel: 'dangerous', levelRequirement: 15, rumors: ['Vampires have been seen nearby', 'Blood altars glow in darkness', 'The undead feast on travelers'], rewards: { gold: { min: 500, max: 1000 }, xp: { min: 400, max: 600 }, items: ['Vampire Dust', 'Enchanted Ring'] } },
  { id: 'broken_fang_cave', name: 'Broken Fang Cave', type: 'cave', x: 24, y: 54, hold: 'Whiterun Hold', description: 'A vampire den west of Whiterun.', dangerLevel: 'dangerous', levelRequirement: 16, rumors: ['Vampires prey on travelers', 'A master vampire rules the coven'], rewards: { gold: { min: 450, max: 850 }, xp: { min: 380, max: 580 } } },
  ...
  { id: 'ice_cavern', name: 'Wayward Pass', type: 'cave', x: 42, y: 10, hold: 'The Pale', description: 'A winding cave of ice and whirling winds.', dangerLevel: 'dangerous', levelRequirement: 12, rumors: ['Ice wolves hunt in packs', 'A shortcut through the mountains'], rewards: { gold: { min: 300, max: 600 }, xp: { min: 250, max: 400 } } },
  { id: 'mineshaft', name: 'Redbelly Mine', type: 'dungeon', x: 86, y: 64, hold: 'The Rift', description: 'An ebony mine infested with spiders.', dangerLevel: 'moderate', levelRequirement: 10, rumors: ['Ebony ore is worth its weight in gold', 'Giant spiders claimed the depths'], rewards: { gold: { min: 400, max: 800 }, xp: { min: 280, max: 450 }, items: ['Ebony Ore'] } },
  { id: 'forsworn_camp', name: 'Lost Valley Redoubt', type: 'dungeon', x: 12, y: 52, hold: 'The Reach', description: 'A massive Forsworn stronghold with a Hagravens\' lair.', dangerLevel: 'dangerous', levelRequirement: 16, rumors: ['Hagravens command the Forsworn', 'A Word Wall lies at the summit'], rewards: { gold: { min: 700, max: 1300 }, xp: { min: 500, max: 800 }, items: ['Forsworn Briarheart', 'Word of Power'] } },
