                  ...
                  <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8">
                    <div className="max-w-4xl mx-auto">
                      <div className="flex items-start justify-between border-b border-skyrim-border/30 pb-6 mb-6">
                        <div>
                          <h4 className="text-3xl font-serif text-skyrim-gold tracking-wide drop-shadow-sm">{getItemName(selected, t)}</h4>
                            ...
                            <div className="max-h-44 overflow-y-auto custom-scrollbar pr-1">
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                {nextUpgradeRequirements.map(r => {
                                  ...
                                  const fallbackName = ((r.itemId || '').replace(/_/g, ' ')).replace(/\b\w/g, ch => ch.toUpperCase());
                                  const pretty = invMatch ? getItemName(invMatch, t) : (shopMatch ? getItemName({ ...shopMatch, baseId: shopMatch.id }, t) : getItemName({ name: fallbackName, baseId: r.itemId }, t));
