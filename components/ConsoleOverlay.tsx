...
const COMMAND_SUGGESTIONS = [
  ...
  'demo.setPerkPoints(5)',
  'demo.forceUnlockPerk("toughness")',
  'demo.grantMastery("toughness",1)',
  'demo.setLevel(10)',
  'demo.giveItem("Iron Sword","weapon",1)',
  'demo.recruitCompanion({ name: "Lydia", race: "Nord", level: 5 })',
  'demo.listCompanions()',
  'demo.removeCompanion("<id>")',
  "demo.clearDemoData({ items: false })",
  // Test modal commands for admin testing
  'demo.openDungeonModal("bleak_falls_barrow")',
  'demo.openDungeonModal("bandit_hideout")',
  'demo.openDungeonModal("labyrinthian")',
  'demo.openCombatModal()',
  'demo.openShopModal()',
  'demo.openLevelUpModal()',
  'demo.openPerkTreeModal()',
  'demo.openCompanionsModal()',
  'demo.openAchievementsModal()',
  'demo.openCharacterSheet()',
  'demo.openInventory()',
  'demo.openJournal()',
  'demo.openSpellsModal()',
  'demo.openRestModal()',
  'demo.testAllModals()',
  'clear',
  'history',
